...
public class LoginActivity extends BaseActivity {
     ...
     * @param firebaseAuth object returned from onAuthenticated
     */
    private void setAuthenticatedUserPasswordProvider(FirebaseAuth firebaseAuth) {
    }

    /**
     * Helper method that makes sure a user is created if the user
     * logs in with Firebase's Google login provider.
     * @param firebaseAuth AuthData object returned from onAuthenticated
     */
    private void setAuthenticatedUserGoogle(FirebaseAuth firebaseAuth){
